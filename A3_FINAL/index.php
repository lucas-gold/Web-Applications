  ...
  <div>
    ...
    <?php  if (isset($_SESSION['username'])) : ?>
      ...
      <?php if ($_SESSION['username'] == "admin") : ?>
        <p style="font-style:italic; position:fixed; margin-top: -17.7%; color:#397487;">&nbsp; Welcome <strong><?php echo $_SESSION['username']; ?>&nbsp;</strong>
          <a href="index.php?logout='1'" style="color: #6db2c9;"> logout</a>&nbsp;<a href="db_attractions.php">DBMaintain</a></p>
        ...
        .when('/cntower', {
          ...
          .when('/theshard', {
            ...
            .when('/casaloma', {
              ...
              .when('/amberpalace', {
                templateUrl : 'readmore.php?q=amberpalace'})
                .when('/bigben', {
                  templateUrl : 'readmore.php?q=bigben'})
                  .when('/bondibeach', {
                    templateUrl : 'readmore.php?q=bondibeach'})
                    .when('/boteromuseum', {
                      templateUrl : 'readmore.php?q=boteromuseum'})
                      .when('/disneyland', {
                        templateUrl : 'readmore.php?q=disneyland'})
                        .when('/eiffeltower', {
                          templateUrl : 'readmore.php?q=eiffeltower'})
                          .when('/forbiddencity', {
                            templateUrl : 'readmore.php?q=forbiddencity'})
                            .when('/greatwall', {
                              templateUrl : 'readmore.php?q=greatwall'})
                              .when('/harbourbridge', {
                                templateUrl : 'readmore.php?q=harbourbridge'})
                                .when('/lostcity', {
                                  templateUrl : 'readmore.php?q=lostcity'})
                                  .when('/milfordsound', {
                                    templateUrl : 'readmore.php?q=milfordsound'})
                                    .when('/mountcook', {
                                      templateUrl : 'readmore.php?q=mountcook'})
                                      .when('/niteroimuseum', {
                                        templateUrl : 'readmore.php?q=niteroimuseum'})
                                        .when('/tajmahal', {
                                          templateUrl : 'readmore.php?q=tajmahal'})
                                          .when('/teresopolis', {
                                            templateUrl : 'readmore.php?q=teresopolis'})
                                            .when('/thelouvre', {
                                              templateUrl : 'readmore.php?q=thelouvre'})
                                              .when('/whitehouse', {
                                                templateUrl : 'readmore.php?q=whitehouse'})
